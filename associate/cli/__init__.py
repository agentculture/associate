...
from associate import __version__
from associate.cli._errors import EXIT_USER_ERROR, CliError
from associate.cli._output import emit_error

_ISSUES_URL = "https://github.com/agentculture/associate/issues"
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    from associate.cli._commands import learn as _learn_cmd
    from associate.cli._commands import overview as _overview_cmd
    from associate.cli._commands import run as _run_cmd
    from associate.cli._commands import whoami as _whoami_cmd

    parser = _CliArgumentParser(
        prog="associate",
        description="associate — a clonable template for AgentCulture mesh agents.",
    )
    parser.add_argument(
        "--version",
        action="version",
