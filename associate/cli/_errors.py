...
Every failure inside associate raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`associate.cli._output`,
...
# Exit-code policy. Documented in ``associate learn`` output.
# 0      = success
